...
type RemotePodSpec struct {
	...
	// Foo is an example field of RemotePod. Edit remotepod_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// RemotePodStatus defines the observed state of RemotePod
...
type RemotePod struct {
	...
	Status RemotePodStatus `json:"status,omitempty"`
}
